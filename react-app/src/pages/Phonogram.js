                        ...
                        <td style={{padding: '0.5vh'}}>
                            <div >
                                ...
                                <ol>
                                    ...
                                    <li style={{margin: '0.5em'}}><i>Двусогласные знаки, обозначающие два согласных звука</i>, например m + n (или кратко, mn); p + r (pr).</li>
                                    <li style={{margin: '0.5em'}}><i>Трёхсогласные знаки, обозначающие три согласных звука</i>, например, nfr ; Htp.</li>
                                </ol>
                            </div>
                        </td>
                        <td width={"40%"}>
