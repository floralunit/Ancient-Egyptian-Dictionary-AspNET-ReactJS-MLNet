...
namespace EgyptianAPI.Services.AuthService
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(EgyptianDBContext context, IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
            _context = context;
        ...
        private async Task SetRefreshToken(RefreshToken refreshToken, User user)
        {
            ...
            user.TokenCreatedDt = refreshToken.Created;
